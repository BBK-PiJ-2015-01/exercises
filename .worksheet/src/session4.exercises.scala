...
*/
  ...
  if (sky == "sunny" && temp > 80) println("Nice!") else println("Hmmm");$skip(18); 

  sky = "cloudy";$skip(12); 
  temp = 80;$skip(93); 
  if (sky == "sunny" || sky == "part cloud" && temp > 80) println("Ok") else println("Hmmm");$skip(22); 

  sky = "part cloud";$skip(13); 
  temp = 100;$skip(112); 
  if (sky == "sunny" || sky == "part cloud" && 20 > temp || temp > 80) println("Extreme!") else println("Hmmm");$skip(57); 

  def fahrenheitToCelsius(f: Double) = (f - 32) * 5 / 9;System.out.println("""fahrenheitToCelsius: (f: Double)Double""");$skip(28); val res$0 = 
  fahrenheitToCelsius(82.4);System.out.println("""res0: Double = """ + $show(res$0));$skip(55); 

  def celsiusToFahrenheit(f: Double) = f * 9 / 5 + 32;System.out.println("""celsiusToFahrenheit: (f: Double)Double""");$skip(26); val res$1 = 
  celsiusToFahrenheit(28);System.out.println("""res1: Double = """ + $show(res$1));$skip(226); 
...
*/
  ...
  assert("123123" == m2, "Your message here");$skip(194); 
...
*/
  ...
  r2 step;System.out.println("""res3: Int = """ + $show(res$3));$skip(20); 
...
*/
  ...
  class Motorboat {
    ...
    def off() = "Motor off"
    def signal() = new Flare light
  };System.out.println("""giraffe3  : session4.exercises.Giraffe = """ + $show(giraffe3 ));$skip(497); 
  ...
  assert(sb2 == "Sails lowered", "Expected Sails lowered, Got " + sb2);$skip(33); 
  ...
  assert(mb2 == "Motor off", "Expected Motor off, Got " + mb2);$skip(25); 
  ...
  assert(f1 == "Flare used!", "Expected Flare used!, Got " + f1);$skip(32); 
  ...
  assert(signal == "Flare used!", "Expected Flare used! Got " + signal);$skip(34); 
